...
import { ArrowUp, Square, X, StopCircle, BrainCog, ChevronDown } from "lucide-react";
              ...
              <div className="relative">
                <PromptInputAction tooltip="Select AI Model">
                  <button
                    ...
                    className="rounded-full transition-all flex items-center gap-1 px-2 py-1 border h-8 bg-transparent border-transparent text-[#9CA3AF] hover:text-[#D1D5DB] hover:bg-gray-600/30"
                  >
                    ...
                    {selectedModel && (
                      <span className="text-xs font-medium">
                        {selectedModel.includes('claude-3-7') ? '3.7' : selectedModel.includes('claude-sonnet-4') ? '4.0' : ''}
                      </span>
                    )}
                ...
                <AnimatePresence>
                  {showModelDropdown && (
                    <motion.div
                      ...
                      className="absolute top-full left-0 mt-2 bg-[#1F2023] border border-[#333333] rounded-xl shadow-lg py-2 min-w-[200px] z-50"
                    >
                      {aiModels.map((model) => (
                        <button
                          key={model.value}
                          ...
                          className={cn(
                            "w-full px-3 py-2 text-left text-sm transition-colors hover:bg-[#2E3033]",
